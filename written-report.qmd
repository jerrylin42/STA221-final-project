...
CARLIEEEEEEE
-   comparing baseline with adding one interaction; look at adjusted r squared, aic, bic, and f test
...
```
SAMIR TRAVERRSSSS
-   removing multi language; F test and see it is not significant; technically our final model
...
SAMIR TRAVERSSSSSSS
-   interpret all coefficients (remember it is log logged –\> gotta think)
