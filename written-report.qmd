...
Therefore, below is our final model we decide to use:
...
Our goal for this project was to understand how to predict movie box office revenue using various elements. In the post-COVID world, we find this topic particularly interesting because of the drop in in-person movie viewership due to developments like streaming services, shifts in the entertainment industry, and more. This project sought to gain a deeper understanding of what truly drives a movie's success or failure in the box office.

Based on our analysis, we can see that the most useful variables were the average vote a movie received, budget, runtime, year it was released, and whether or not the movie was categorized as having multiple genres.
