...
Then, we will take care of the issue of multicollinearity by using the VIF to see which predcictor variables could have correlation.
...
-   augment + look at residuals to see if constant variance and normality of residuals is satisfied

-   anova/f-test to compare. (when comparing, do we use AIC, BIC, adj-r\^2, or RMSE?)
